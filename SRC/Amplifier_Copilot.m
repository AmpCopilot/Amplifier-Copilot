...
% Haochang, 2025-12
    ...
    uicontrol(panelL,'Style','pushbutton','Units','normalized',...
              'Position',[0.05 0.21 0.9 0.026],'String','Add Constraint',...
              'Callback',@addAdvCallback);
    
    lbAdv = uicontrol(panelL,'Style','listbox','Units','normalized',...
              'Position',[0.05 0.06 0.9 0.13],'String',advList,...
              'Max',2,'Min',0,'TooltipString','Press DELETE key to remove');
    
    txtCount = uicontrol(panelL,'Style','text','Units','normalized',...
              'Position',[0 0.03 1 0.02],'String','Data available: 0',...
              'HorizontalAlignment','center','FontWeight','bold');
    
    uicontrol(panelL,'Style','pushbutton','Units','normalized',...
              'Position',[0.05 0.003 0.9 0.024],'String','🔄 RESET',...
